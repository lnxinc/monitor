...
class NotificationChannelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'type' => ['required', 'in:email,slack_webhook,webhook'],
            'config' => ['nullable', 'array'],
            'config.email' => ['required_if:type,email', 'nullable', 'email', 'max:255'],
            'config.webhook_url' => ['required_if:type,slack_webhook', 'nullable', 'url', 'max:2048'],
