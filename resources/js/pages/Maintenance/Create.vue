...
interface Props { organizations: Opt[]; devices: Opt[]; monitors: Opt[] }
const props = defineProps<Props>();

const breadcrumbs: BreadcrumbItem[] = [ { title:'Dashboard', href:'/dashboard' }, { title:'Maintenance', href:'/maintenance' }, { title:'Create', href:'/maintenance/create' } ];
