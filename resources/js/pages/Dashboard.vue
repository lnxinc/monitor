...
import { Activity, AlertTriangle, CheckCircle, Server, XCircle, Building2, Plus, Maximize, Minimize2 } from 'lucide-vue-next';
...
const refresh = () => router.reload({ only: ['stats', 'recentIncidents', 'devicesByStatus', 'incidentsBySeverity'] });
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex items-center justify-between">
                <h1 class="text-3xl font-bold tracking-tight">Network Operations Dashboard</h1>
