...
import { Camera, Cloud, Cpu, Database, Edit, Globe, HardDrive, Monitor, Plus, Printer, Server, ServerCog, Shield, Trash2 } from 'lucide-vue-next';
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex items-center justify-between">
                ...
                <Link href="/device-types/create">
                    <Button><Plus class="mr-2 h-4 w-4" /> Add Type</Button>
                </Link>
            </div>

            <div v-if="props.types.length === 0" class="py-12 text-center">
            ...
            <div v-else class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card v-for="t in props.types" :key="t.id">
                    ...
                    <CardContent>
                        <p v-if="t.description" class="mb-4 text-sm text-muted-foreground">{{ t.description }}</p>
                        <div class="flex items-center justify-between">
